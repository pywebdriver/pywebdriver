...
+(function (a) {
  ...
  +(function (a) {
    ...
    (a.fn.collapse = function (c) {
      ...
      a(document).on("click.bs.collapse.data-api", "[data-toggle=collapse]", function (
        b
      ) {
        var c,
          d = a(this),
    ...
    (f.prototype.toggle = function (d) {
      ...
      (f.prototype.keydown = function (b) {
        if (/(38|40|27)/.test(b.keyCode)) {
          var d = a(this);
          if (
            (b.preventDefault(), b.stopPropagation(), !d.is(".disabled, :disabled"))
          ) {
            var f = c(d),
              g = f.hasClass("open");
            if (!g || (g && 27 == b.keyCode))
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (g) {
            var k = this.$element.parent(),
              ...
              o =
                "body" == this.options.container ? window.innerHeight : k.outerHeight(),
