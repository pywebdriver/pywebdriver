...
(function (e, undefined) {
  ...
  (x.fn = x.prototype = {
    ...
    x.extend({
      ...
      makeArray: function (e, t) {
        ...
        return (
          null != e &&
            (j(Object(e)) ? x.merge(n, "string" == typeof e ? [e] : e) : h.call(n, e)),
          n
        );
      },
      ...
      (s = ot.isXML = function (e) {
        ...
        (ot.uniqueSort = function (e) {
          var t,
            ...
            o = 0;
          if (
            ((E = !n.detectDuplicates), (l = !n.sortStable && e.slice(0)), e.sort(S), E)
          ) {
      ...
      function wt(e) {
        var t,
          ...
          f = [
            function (e, n, r) {
              return (
                (!s && (r || n !== u)) || ((t = n).nodeType ? c(e, n, r) : p(e, n, r))
              );
            },
          ];
        for (; o > l; l++)
        ...
        ? (e && e.type
            ? ((this.originalEvent = e),
              ...
              (this.isDefaultPrevented =
                e.defaultPrevented || (e.getPreventDefault && e.getPreventDefault())
                  ? U
                  : Y))
            : (this.type = e),
          t && x.extend(this, t),
  ...
  (ct.optgroup = ct.option),
    ...
    x.fn.extend({
      ...
      domManip: function (e, t, n) {
        ...
        if (
          g ||
          (!(1 >= c || "string" != typeof d || x.support.checkClone) && st.test(d))
        )
  ...
  function Lt(e, t) {
    return (
      (e = t || e), "none" === x.css(e, "display") || !x.contains(e.ownerDocument, e)
    );
  }
  function qt(t) {
  ...
  (x.Tween = Ln),
    ...
    x.fn.extend({
      ...
      animate: function (e, t, n, r) {
        ...
        return (
          (s.finish = s), i || o.queue === !1 ? this.each(s) : this.queue(o.queue, s)
        );
      },
      stop: function (e, t, n) {
        var r = function (e) {
