...
a = Analysis(['..\\pywebdriverd'],
             ...
             ('..\\venv\\Lib\\site-packages\\pip\\_vendor\\certifi\\cacert.pem', 'pip\\_vendor\\certifi\\'),
             ],
             ...
             'pywebdriver.plugins.win32print_driver', 'pywebdriver.plugins.mettler_toledo_driver',
